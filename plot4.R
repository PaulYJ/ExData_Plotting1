...
plot(raw_sel[,10],raw_sel[,5],ylab="Voltage",xlab="datetime",type='l')
...
legend("topright",legend=c("Sub_metering_1","Sub_metering_2","Sub_metering_3"),lty=c(1,1,1),col=c("black","red","blue"),box.col = NA)
plot(raw_sel[,10],raw_sel[,4],ylab="Global_reactive_power",xlab="datetime",type='l',ylim=c(0.0,0.5))
dev.off()
